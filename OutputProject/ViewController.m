...
- (void)phoneRecharge
{
    [[XTModulesManager sharedManager] showPhoneRechargeWithSourceVC:self mode:XTModuleShowModePresent phone:@"18640048241"];
}

- (void)refuel
{
    [[XTModulesManager sharedManager] showRefuelWithSourceVC:self mode:XTModuleShowModePresent phone:@"18640048241"];
}

- (void)lifePayment
{
    [[XTModulesManager sharedManager] showLifePaymentWithSourceVC:self mode:XTModuleShowModePresent phone:@"18640048241"];
}
